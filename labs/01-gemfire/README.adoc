...
If you are using the VM, this step will have already been created for you. In this case, proceed to the next step. +
...
If the workspace has already been cloned from Git hub, skip the following step. +
